...
const tahunAjaran = () => {
    // tahunAjaranValue =   $('select[name=tahun_ajaran] option').filter(':selected').val();
    // console.log('tahunAjaranValue =>',tahunAjaranValue)
    // fetchData(search , dataSelect ,tahunAjaranValue);
...
$('#search').on('keyup' ,function() {
    ...
    search = this.value;
    dataSelect =   $('select[name=number] option').filter(':selected').val();
