...
/* effect-4 */
    ...
    <div class="container">
            <center>
                ...
                <div id="tampilkan" class="tampilkan">
		...
		<div class="tabs effect-1" style="margin-top: 60px">
            ...
            <div class="card">
                <div class="card-body">
                   ...
                   <select  class="count-data" id="choice" style="width:10%" name="number" id="cars">
...
<script>
    ...
    let paginate = '';
    let tmpPage = [];
    let tahunAjaran = document.getElementById('tahun_ajaran').value;
    let ajaxParams = {};
...
function pageinate(id){
    ...
    function queryParams(params) {
        ...
        let query = 'controller/fetch _all_data.php' + '?' + queryParams(params);
...
async function main() {
    ...
    function queryParams(params) {
        ...
        let params = {
            "tahunAjaran": "2021/2022 Genap",
        };

        params = Object.assign({}, ajaxParams, params);

        let query = 'controller/fetch_count_data.php' + '?' + queryParams(params);


    countData2 = await getJson(query);
    countData2 = countData2.data
    console.log('countData2', countData2);
    countPage = Math.ceil(countData2/dataSelect);
...
document.getElementById('tampilkan').onclick = async function() {
